...
export class MyBarChartComponent implements OnInit {
  ...
  public barChartLabels = ['Desarrollo de Software', 'Diseño de Modas', 'Arte Culinario', 'Marketing', 'Guia de Turismo'];
...
doc.setFontSize(25);
doc.setTextColor(8, 0, 80);
doc.text(55, 50, 'SOLICITUD DE ANULACIÓN'),
doc.setTextColor(0, 0, 0);
doc.setFontSize(12);
doc.text(10, 70, 'Quito, ____de______del________.'),
doc.text(10, 80, 'Yo________________________________________del número de cédula______________________________,'),
doc.text(10, 90, 'solicito se anule mi anterior solicitud de ingreso para el periodo año lectivo____________________________,'),
doc.text(10, 100, 'para la carrera de ___________de este prestigioso instituto.'),
doc.text(10, 120, 'Por las siguientes razones: __________________________________________________________________'),
doc.text(10, 130, '________________________________________________________________________________________'),
doc.text(10, 140, '________________________________________________________________________________________.'),
...
doc.save('Solicitud de ingreso.pdf');
  ...
  doc.setFontSize(25);
  doc.setTextColor(8, 0, 80);
  doc.text(55, 50, 'COMPROBANTE DE ACEPTACIÓN'),
  doc.setTextColor(0, 0, 0);
  doc.setFontSize(12);

  doc.text(10, 70, 'Quito, ____de______del________.'),
  doc.text(10, 100, 'Nos complace informarle que usted,______________________ con número de cédula de identidad '),
  doc.text(10, 110, '________________, que ha sido aceptado por el prestigioso Instituto Tecnológico Superior Yavirac.'),
  doc.text(10, 120, 'Acercarse al Instituto en la fecha_____________________, para que proceda con la respectiva matrícula.')
  doc.text(10, 130, ' que corresponde al presente año lectivo_______________'),
